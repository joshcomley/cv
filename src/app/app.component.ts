...
export class AppComponent implements OnInit {
  ...
  constructor(@Inject(DOCUMENT) protected document: Document, private route: ActivatedRoute) {
    ...
    //         `
    //         <ul>
    // <li>An Angular based, HTML5 web application</li>
    ...
    // </ul>`,
    //         ["C#", ".NET", "SharePoint Online", "Graph API", "Active Directory", ".NET Core", "Angular", "Azure", "SOLID", "Bootstrap", "Mobile", "XHTML", "CSS", "JavaScript", "jQuery", "LINQ"]));
    ...
    // </ul>`,
    //         ["C#", ".NET", "Angular", "AngularJS", "Azure", "Code First", "MVC5", "Entity Framework 6", "BDD", "TDD", "SOLID", "REST", "Bootstrap", "Xamarin", " Mobile", "C# 4.0", "ASP.NET", "SQL Server", "XHTML", "CSS", "JavaScript", "jQuery", "LINQ"]));
